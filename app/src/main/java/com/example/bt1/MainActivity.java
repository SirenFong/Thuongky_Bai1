    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDialog.setPositiveButton("Chơi tiếp", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(MainActivity.this, "Lượt mới", Toast.LENGTH_SHORT).show();
                recreate();
            }
        });
        ...
        if (tinhsoTay(baso) == 3)
            ...
            for (int i = 0; i < baso.length; i++)
                if (baso[i] % 13 < 10)
                    tong += baso[i] % 13 + 1;
            if (tong % 10 == 0)
                KQ = "Bài bù và trong đó có " + tinhsoTay(baso) + " tây";
            else
                KQ = "Kết quả: " + tong % 10 + " nút và trong đó có " + tinhsoTay(baso) + " tây";
        }
        return KQ;
    }
